...
<?php } ?>
    ...
    <div class="navbar">
        ...
        <a    class="active"  href="loginadmin.php">Login as Admin</a>
    ...
    <div class="content">
        ...
        <h2 style = "padding:10px;background:grey;text-align:center;border-radius:10px;box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;">Login as Admin</h2>
        <?php
        if (!isset($_SESSION['user_id']) || !isset($_SESSION['admin'])) {
					?>
